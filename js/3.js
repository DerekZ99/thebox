...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"render\", function() { return render; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"staticRenderFns\", function() { return staticRenderFns; });\nvar render = function() {\n  var _vm = this\n  var _h = _vm.$createElement\n  var _c = _vm._self._c || _h\n  return _c(\n    \"div\",\n    { staticClass: \"canada\" },\n    [\n      _c(\"p\", [\n        _vm._v(\n          \"我在我17岁,也就是2013年左右去了加拿大读书，在那呆了六年的时间。\"\n        )\n      ]),\n      _c(\"p\", [\n        _vm._v(\n          \"虽然在College修的不是计算机专业，但是期间接触了编程，这使我对编程产生了极大的兴趣。回国后，就决定要钻研前端，做一名优秀的程序员。\"\n        )\n      ]),\n      _c(\"p\", [\n        _vm._v(\n          \"在学习前端的历程中有遇到过不少的问题。当遇到bug的时候，我会先看报错信息，看看是哪里出了问题。然后再检查自己的代码是否有拼写错误。之后，再着重分析报错原因和思考解决方案。\"\n        )\n      ]),\n      _c(\"p\", [\n        _vm._v(\n          \"在制作这个博客的过程中，我也收获了许多。我把它分享给我的朋友，让他们作为用户给我提出一些改进的意见。我会针对每一条意见作出相应的改进，完善和添加一些功能。比如添加点击图片放大功能，对图片加载过慢做一些优化，又或者是布局和背景图片方面的问题。\"\n        )\n      ]),\n      _c(\"p\", [\n        _vm._v(\n          \"因此，我变得更加严谨，我会坚持贯彻这种严谨的态度，写出更好的代码\"\n        )\n      ]),\n      _vm.$store.state.isShowFooter\n        ? _c(\n            \"el-collapse\",\n            {\n              staticClass: \"collapse\",\n              on: { change: _vm.handleChange },\n              model: {\n                value: _vm.activeNames,\n                callback: function($$v) {\n                  _vm.activeNames = $$v\n                },\n                expression: \"activeNames\"\n              }\n            },\n            [\n              _c(\n                \"el-collapse-item\",\n                {\n                  attrs: {\n                    title:\n                      \"这里有在加拿大拍的照片，点击下方图片可以放大。点击此处可以隐藏图片\",\n                    name: \"1\"\n                  }\n                },\n                [\n                  _c(\n                    \"el-carousel\",\n                    {\n                      directives: [\n                        {\n                          name: \"show\",\n                          rawName: \"v-show\",\n                          value: _vm.isShowSwiper,\n                          expression: \"isShowSwiper\"\n                        }\n                      ],\n                      attrs: { interval: 8000 }\n                    },\n                    _vm._l(_vm.canadaImg, function(item) {\n                      return _c(\n                        \"el-carousel-item\",\n                        { key: item.id, staticClass: \"swiper\" },\n                        [\n                          _c(\"h3\", [_vm._v(_vm._s(item.title))]),\n                          _c(\"img\", {\n                            directives: [\n                              {\n                                name: \"lazy\",\n                                rawName: \"v-lazy\",\n                                value: item.img,\n                                expression: \"item.img\"\n                              }\n                            ],\n                            staticClass: \"image\",\n                            attrs: { alt: \"\" },\n                            on: {\n                              click: function($event) {\n                                return _vm.imgClick(item)\n                              }\n                            }\n                          })\n                        ]\n                      )\n                    }),\n                    1\n                  )\n                ],\n                1\n              )\n            ],\n            1\n          )\n        : _c(\n            \"el-carousel\",\n            { attrs: { interval: 8000, arrow: \"always\" } },\n            _vm._l(_vm.canadaImg, function(item) {\n              return _c(\n                \"el-carousel-item\",\n                { key: item.id, staticClass: \"swiper\" },\n                [\n                  _c(\"h3\", [_vm._v(_vm._s(item.title))]),\n                  _c(\"img\", {\n                    directives: [\n                      {\n                        name: \"lazy\",\n                        rawName: \"v-lazy\",\n                        value: item.img,\n                        expression: \"item.img\"\n                      }\n                    ],\n                    staticClass: \"image\",\n                    attrs: { alt: \"\" },\n                    on: {\n                      click: function($event) {\n                        return _vm.imgClick(item)\n                      }\n                    }\n                  })\n                ]\n              )\n            }),\n            1\n          )\n    ],\n    1\n  )\n}\nvar staticRenderFns = []\nrender._withStripped = true\n\n\n\n//# sourceURL=webpack:///./src/views/myself/childComps/Canada.vue?./node_modules/cache-loader/dist/cjs.js?%7B%22cacheDirectory%22:%22node_modules/.cache/vue-loader%22,%22cacheIdentifier%22:%22ad52c68a-vue-loader-template%22%7D!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options");
